 ...
 **
 ** _DFRAC: Double Fraction
 ** _DMASK: Double Mask;
 ** _DMax:  Double Max;
 ** _DNAN:  Double NAN;
 ** _DSIGN: Double Signed 
 ** _Dint:  Double int
 ** _Dnorm: Double normalization
 ** _Dtento: Double 10**N * x
 ** _Dtest: Double test, categorize the double values 
 ** _Dscale: Double scale 
 ** _Dunscale: Double type, combine _Dtest and frexp function 
 ** _Ldunscale: Long double
 ** _Poly: Poly function with Horner rule
 ** _Exp: Exponent
