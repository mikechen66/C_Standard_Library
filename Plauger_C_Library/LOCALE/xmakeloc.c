...
static const char *getval(const char *s, unsigned short *ans) {   // accumulate terms
...
int _Makeloc(FILE *lf, char *buf, _Linfo *p) {   // construct locale from text file
