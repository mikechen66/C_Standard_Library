...
static short dnorm(unsigned short *ps) { // normalize long double fraction
...
short _Ldunscale(short *pex, long double *px) {  // separate *px to |frac| < 1/2 and 2^*pex
