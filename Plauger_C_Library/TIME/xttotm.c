...
int _Daysto(int year, int mon) {  // compute extra days to start of month
...
struct tm *_Ttotm(struct tm *t, time_t secsarg, int isdst) {  // convert scalar time to time structure
